...
<script language="javascript">
    ...
    function get_image_post()
    {
        var rd_val = "";
        for( i = 0; i < document.form1.rdImg.length; i++ )
        {
            if( document.form1.rdImg[i].checked == true )
            rd_val = document.form1.rdImg[i].value;
        }
...
<form method="post" name="form1">
    ...
    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td style="display:<?php echo $timer_display ?>" align="left">
                ...
                &nbsp;&nbsp;<span class="label" style="font-size:15px;">Time : <label id="lblTimer" style="color:red"></label></span>
                </div>
            </td>        
            <td class="desc_text_bg2" align="right">
			
                <div class="label" id="divPager" style="display:<?php echo $pager_display ?>">
                    <span class="label">Questions : <?php echo $pager_html ?></span>
                </div>
            </td>                   
    ...
    &nbsp;
    <div class="label" align="center" id="divMsg" style="font-size:20px;display:<?php echo $msg_display ?>">
